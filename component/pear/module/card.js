layui.define(["table", "laypage", "jquery", "element"], function (exports) {
  ...
  card.prototype.init = function () {
    ...
    html +=
      option.loading == true
        ? '<div class="ew-table-loading">'
        : '      <div class="ew-table-loading layui-hide">';
    html +=
  ...
  function createCard(elem, linenum, item, no) {
    ...
    var card =
      ...
      no +
      '" data-number="1"> <div class="project-list-item"> <img class="project-list-item-cover" src="' +
      item.image +
      '"> <div class="project-list-item-body"> <h2>' +
      item.title +
  ...
  function getData(url) {
    var defer = $.Deferred();
    $.get(
      url + (url.indexOf("?") ? "&" : "?") + "fresh=" + Math.random(),
      function (result) {
